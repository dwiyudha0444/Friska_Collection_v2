                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('add-to-keranjang') }}" method="post">
                                                ...
                                                @endphp
                                                @if ($pro->stok == 0)
                                                    <button type="button" class="styled-button-red" disabled>Stok
                                                        Habis</button>
                                                @elseif ($inCart)
                            ...
                            $(document).ready(function() {
                                $('.quantity-spinner').on('change', function() {
                                    ...
                                    if (qty > maxQty) {
                                        ...
                                        $(this).val(maxQty); // Mengembalikan nilai ke stok maksimum
                                        qty = maxQty; // Set qty to maxQty for the AJAX request
                                    }
